@php
    $support_phone=getSettingValue('support-phone');
    $support_email=getSettingValue('support-email');
@endphp
    ...
    <div class="container">
      <div class="grid grid-cols-12 mb-20 max-lg:gap-y-10 max-lg:text-center">
        <div class="col-span-12 lg:col-span-6">
          <img
            ...
            alt="logo"
            class="inline-block dark:hidden mb-10"
          />
          <img
            src="{{asset('assets/images/logo-light.svg')}}"
            alt="logo dark version"
            class="hidden dark:inline-block  mb-10"
          />
          <p class="max-w-[350px] max-lg:mx-auto">
            {{__('index.footer-desc')}}
          </p>
        </div>
        <div class="col-span-12 lg:col-span-2 max-lg:text-center">
          <h3 class="mb-8 font-medium text-lg">{{__('index.explore')}}</h3>
          <ul class="[&>*:not(:last-child)]:mb-3">
            ...
            <li>
              <a
                ...
                class="relative inline-block overflow-hidden text-base capitalize text-paragraph dark:text-white before:absolute before:bottom-0 before:left-0 before:h-[1px] before:w-full before:origin-right before:scale-x-0 before:bg-paragraph dark:before:bg-white  before:transition-transform before:duration-500 before:content-[''] before:hover:origin-left before:hover:scale-x-100"
              >
                {{__('index.testimonials')}}
              </a>
            </li>
          </ul>
        </div>
        <div class="col-span-12 lg:col-span-2 max-lg:text-center">
          <h3 class="mb-8 font-medium text-lg">{{__('index.resources')}}</h3>
          <ul class="[&>*:not(:last-child)]:mb-3">
            <li>
              <a
                href="{{route('blogs')}}"
        ...
        <div class="col-span-12 lg:col-span-2 max-lg:text-center">
          <h3 class="mb-8 font-medium text-lg">{{__('index.get-in-touch')}}</h3>
          <p class="mb-3">{{__('index.need-support')}}?</p>
          <p class="mb-3">
            <a
      ...
      <div class="py-10 max-lg:text-center">
        <div class="flex max-lg:flex-col lg:items-center">
          <p class="max-lg:mb-10">@ <span id="date"></span> SkillSwap. {{__('index.all-rights-reserved')}}</p>
