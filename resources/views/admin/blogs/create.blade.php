        ...
        <div class="row layout-top-spacing">
            <div class="col-xl-12 col-lg-12 col-sm-12  layout-spacing">
                <div class="widget-content widget-content-area br-8">
                    <div class="row mb-4">
                        <div class="col-8">
                            <h4>{{__('dashboard.add-new-blog')}}</h4>
                        </div>
                    ...
                    <form method="POST" action="{{route('admin.blogs.store')}}" enctype="multipart/form-data">
                        ...
                        <div class="row mb-4">
                            ...
                            <div class="col-6">
                                <div class="mb-3">
                                    <label for="thumbnail">{{__('dashboard.image')}} <span class="text-danger">*</span> </label>
                                    <input class="form-control file-upload-input" type="file" id="thumbnail" name="thumbnail" required>
                                </div>
                            </div>
                            <div class="col-6">
                                <div class="mb-3">
                            ...
                            <div class="col-6">
                                <div class="mb-3">
                                    ...
                                    <select class="form-control select2TagList" multiple name="tags[]" id="tags">
                                        @foreach($tags as $tag)
                                            <option value="{{ $tag->name }}" {{ in_array($tag->id, old('tags', [])) ? 'selected' : '' }}>
                                                {{ $tag->name }}
                                            </option>
                                        @endforeach
                                    </select>
                            ...
                            <div class="col-12">
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="meta_title" id="metaTitle" class="form-control" placeholder="Meta Title" required>
                                </div>
                            </div>
                            <div class="col-12">
                                <div class="mb-3">
                                    <label for="metaDesc">{{__('dashboard.meta-description')}} <span class="text-danger">*</span> </label>
                                    <textarea name="meta_description" id="metaDesc" class="form-control" placeholder="Meta Description" rows="5" required></textarea>
                                </div>
                            </div>
                            <div class="col-12">
                                <div class="mb-3">
                            ...
                            <div class="col-12">
                                <div class="mb-3">
                                    ...
                                    <textarea name="content" class="form-control" id="blog-content" cols="30" rows="10"></textarea>
                                    @error('content')
                                        <div class="alert alert-danger">{{ $message }}</div>
                                    @enderror
                                </div>
