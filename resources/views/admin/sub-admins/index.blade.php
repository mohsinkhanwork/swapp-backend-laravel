        ...
        <div class="row layout-top-spacing">
            <div class="col-xl-12 col-lg-12 col-sm-12  layout-spacing">
                <div class="widget-content widget-content-area br-8">
                    <div class="row mb-4">
                        <div class="col-8">
                            <h4>{{__('dashboard.sub-admins')}}</h4>
                        </div>
                        <div class="col-4 text-end">
                            <a class="btn btn-success" href="{{route('admin.sub-admins.create')}}">{{__('dashboard.add-new')}}</a>
                        </div>
                    </div>
                        ...
                        <tbody>
                            @foreach ($admins as $admin)
                                <tr>
                                    ...
                                    <td>
                                        <a class="btn btn-info btn-icon" href="{{route('admin.sub-admins.edit',$admin->id)}}">
                                            <i class="fa-solid fa-pen-to-square"></i>
                                        </a>
                                        <form action="{{route('admin.sub-admins.destroy',$admin->id)}}" class="d-inline" method="post">
                                            @csrf
                                            @method('DELETE')
                                            <button class="btn btn-danger btn-icon m-2 delete-admin" type="button">
