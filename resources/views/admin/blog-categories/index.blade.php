                ...
                <div class="widget-content widget-content-area br-8">
                    <div class="row mb-4">
                        ...
                        <div class="col-4 text-end">
                            <a class="btn btn-success" href="{{route('admin.blog-categories.create')}}">Add New</a>
                        </div>
                    </div>
                        ...
                        <tbody>
                            @foreach ($categories as $category)
                                <tr>
                                    ...
                                    <td>
                                        <a class="btn btn-info btn-icon" href="{{route('admin.blog-categories.edit',$category->id)}}">
                                            <i class="fa-solid fa-pen-to-square"></i>
                                        </a>
                                        <form action="{{route('admin.blog-categories.destroy',$category->id)}}" class="d-inline" method="post">
                                            @csrf
                                            @method('DELETE')
