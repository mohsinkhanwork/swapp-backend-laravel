        ...
        <div class="row layout-top-spacing">
            <div class="col-xl-12 col-lg-12 col-sm-12  layout-spacing">
                <div class="widget-content widget-content-area br-8">
                    <div class="row mb-4">
                        <div class="col-8">
                            <h4>{{__('ad.post-new-notification-ad')}}</h4>
                        </div>
                        ...
                        <div class="row mb-4">
                            ...
                            <div class="col-6">
                                <div class="mb-3">
                                    ...
                                    <input type="url" name="url" id="link" class="form-control" placeholder="link">
                                </div>
                            </div>
                            <div class="col-6">
                                <div class="mb-3">
                            ...
                            <div class="col-12">
                                <div class="mb-3">
                                    ...
                                    <textarea name="description" id="desc" class="form-control" placeholder="Description" rows="2" required maxlength="100"></textarea>
                                </div>
                            </div>
                            <div class="col-12">
                                <div class="mb-3">
    ...
    <script>
        ...
        $(document).ready(function(){
            $("#postAdForm").on('submit',function(e){
                ...
                text: "After form submission you will be redirected to the payment page. after payment, your ad will go to admin for short review and then published automatically.",
                icon: 'warning',
